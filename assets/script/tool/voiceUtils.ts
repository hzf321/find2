...
export class voiceUtils {
    ...
    constructor() {
        this.musicSwitch = stockpileUtils.getBoolByKey("kk_setup_music", true);
        this.effectSwitch = stockpileUtils.getBoolByKey("kk_setup_effect", true);
        this.shockSwitch = stockpileUtils.getBoolByKey("kk_setup_shock", true);
    }

    public switchMusic(): void {
        this.musicSwitch = !this.musicSwitch;
        stockpileUtils.setBoolByKey("kk_setup_music", this.musicSwitch);
        if (this.musicSwitch) {
            if (this.currMusic) {
    ...
    public switchEffect(): void {
        ...
        stockpileUtils.setBoolByKey("kk_setup_effect", this.effectSwitch);
    ...
    public switchShock(): void {
        ...
        stockpileUtils.setBoolByKey("kk_setup_shock", this.shockSwitch);
    }
